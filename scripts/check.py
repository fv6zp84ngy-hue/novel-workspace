...
private_terms = ['on'+'boarding','abo'+'arding','first'+'-value-studio','First '+'Value Studio','12'+'%','lab'+'.html','/'+'Users/']
...
subprocess.run(['node','--test','tests/core.test.mjs','tests/advanced.test.mjs','tests/live.test.mjs'],cwd=ROOT,check=True)
...
print(f'PASS: {len(files)} public files, syntax, links, release hygiene, core and server tests')
